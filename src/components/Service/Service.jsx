...
export class Service extends Component {
    render() {
        const content = "Các dịch vụ kèm theo tang lễ phù hợp với các tôn giáo khác nhau như nhạc bắc, nhạc nam, nhạc tây, thầy tụng, hoa tươi,... theo yêu cầu của gia đình.";
        return (
            <div className={this.props.className}>
                ...
                <div className="-mt-16 grid grid-cols-2 col-gap-4 gap mx-4 row-gap-10">
                    ...
                    <ServiceCard
                        ...
                        src="https://res.cloudinary.com/livestreamzz/image/upload/v1585900602/92412724_203978664227879_3889418316200017920_n_bj4n2z.jpg"
                    />
